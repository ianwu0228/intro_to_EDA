...
bool Floorplanner::solveCluster(Cluster* c, float targetWidth, float targetHeight) {
    ...
    */
    ...
    auto vname_x = [&](int i){ return std::string("x_") + std::to_string(i); };
    auto vname_y = [&](int i){ return std::string("y_") + std::to_string(i); };
    auto vname_r = [&](int i){ return std::string("r_") + std::to_string(i); };
    auto vname_p = [&](int i,int j){ return std::string("p_")+std::to_string(i)+"_"+std::to_string(j); };
    auto vname_q = [&](int i,int j){ return std::string("q_")+std::to_string(i)+"_"+std::to_string(j); };
